...
var scenes = [
  {id:"Malakai's Room",
   sound: {src: "Malakai Audio", volume: 1.0, loop: -1},
...
//      {id: "Malakai", img:"images/MalakaiSpriteBase.png", loc: {x:200, y:900}, animated: true, clickable: false},
//      // {id: "Malakai Textbox", img:"images/rear-mountains.png", loc: {x:0, y:0}, animated: false, clickable: false},
//      {id: "character", img:"images/hero.png", loc: {x:600, y:900}, clickable: true, onClick:"smile"},
//      {id: "front-mountains", img:"images/front-mountains.png", loc: {x:0, y:0}, animated: false, clickable: false}
//      ],
...
//      {type: "animation", id: "character",
//                   animation: {wait: 0,
//                               startPosition:{x:0, y:-400, alpha:1, rotation:0, scaleX:0.75, scaleY:0.75},
//                               endPosition:{x:0, y:0, alpha:1, rotation:0, scaleX:1, scaleY:1},
//                               duration: 3000},
//                   clickable: true, onClick:"smile", trigger: "stageClick", doNext: "nextAction"},
//      {type: "text", speaker: "Hero", text: "It can be called nothing but love, \rthis drive I have toward you.", style: blackTextStyle,
//             loc: {x:550,y:520}, trigger: "stageClick", doNext: "nextAction", hideAfter:2},
